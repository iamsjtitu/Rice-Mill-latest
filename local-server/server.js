...
app.post('/api/private-paddy', (req, res) => {
...
app.get('/api/private-paddy', (req, res) => {
  if (!database.data.private_paddy) database.data.private_paddy = [];
...
app.put('/api/private-paddy/:id', (req, res) => {
  if (!database.data.private_paddy) database.data.private_paddy = [];
...
app.delete('/api/private-paddy/:id', (req, res) => {
  if (!database.data.private_paddy) database.data.private_paddy = [];
  const idx = database.data.private_paddy.findIndex(i => i.id === req.params.id);
  if (idx === -1) return res.status(404).json({ detail: 'Not found' });
...
app.post('/api/rice-sales', (req, res) => {
...
app.get('/api/rice-sales', (req, res) => {
  if (!database.data.rice_sales) database.data.rice_sales = [];
  const { kms_year, season, party_name } = req.query;
...
app.put('/api/rice-sales/:id', (req, res) => {
  if (!database.data.rice_sales) database.data.rice_sales = [];
...
app.delete('/api/rice-sales/:id', (req, res) => {
  if (!database.data.rice_sales) database.data.rice_sales = [];
  const idx = database.data.rice_sales.findIndex(i => i.id === req.params.id);
  if (idx === -1) return res.status(404).json({ detail: 'Not found' });
...
app.post('/api/private-payments', (req, res) => {
...
app.get('/api/private-payments', (req, res) => {
  if (!database.data.private_payments) database.data.private_payments = [];
...
app.delete('/api/private-payments/:id', (req, res) => {
  if (!database.data.private_payments) database.data.private_payments = [];
