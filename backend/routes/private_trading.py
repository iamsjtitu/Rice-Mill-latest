...
async def _create_cashbook_diesel_for_pvt_paddy(doc, username=""):
    ...
    if total_amount > 0:
        ...
        await db.cash_transactions.insert_one({
            ...
            "amount": round_amount(total_amount), "bank_name": "",
    ...
    if final_qntl > 0 and truck_no:
        ...
        await db.cash_transactions.insert_one({
            ...
            "amount": round_amount(gross_amount), "bank_name": "",
    ...
    if cash_paid > 0 and truck_no:
        ...
        await db.cash_transactions.insert_one({
            ...
            "amount": round_amount(cash_paid), "reference": f"pvt_paddy_cash:{entry_id[:8]}",
            **base_fields
        })
        ...
        await db.cash_transactions.insert_one({
            ...
            "category": truck_no, "party_type": "Truck",
            "description": cash_desc,
            "amount": round_amount(cash_paid), "reference": f"pvt_paddy_tcash:{entry_id[:8]}",
            **base_fields
        })
    ...
    if diesel_paid > 0:
        ...
        await db.diesel_accounts.insert_one({
            ...
            "mandi_name": mandi, "amount": round_amount(diesel_paid), "txn_type": "debit",
        ...
        if truck_no:
            ...
            await db.cash_transactions.insert_one({
                ...
                "category": truck_no, "party_type": "Truck",
                "description": diesel_desc,
                "amount": round_amount(diesel_paid), "reference": f"pvt_paddy_tdiesel:{entry_id[:8]}",
                **base_fields
            })
    ...
    if advance_paid > 0:
        ...
        await db.cash_transactions.insert_one({
            ...
            "amount": round_amount(advance_paid), "reference": f"pvt_paddy_adv:{entry_id[:8]}",
            **base_fields
        })
        ...
        await db.cash_transactions.insert_one({
            ...
            "category": party_label, "party_type": "Pvt Paddy Purchase",
            "description": adv_desc,
            "amount": round_amount(advance_paid), "reference": f"pvt_paddy_advl:{entry_id[:8]}",
            **base_fields
        })
...
async def _create_cashbook_for_rice_sale(doc, username=""):
    ...
    if total > 0:
        ...
        await db.cash_transactions.insert_one({
            ...
            "amount": round_amount(total), "reference": f"rice_sale_jama:{entry_id[:8]}",
            **base
        })
    ...
    if cash_paid > 0 and truck_no:
        ...
        await db.cash_transactions.insert_one({
            ...
            "category": truck_no, "party_type": "Truck",
            "description": cash_desc,
            "amount": round_amount(cash_paid), "reference": f"rice_sale_cash:{entry_id[:8]}",
            **base
        })
        await db.cash_transactions.insert_one({
            "id": str(uuid.uuid4()), "date": date,
            ...
            "category": truck_no, "party_type": "Truck",
            "description": cash_desc,
            "amount": round_amount(cash_paid), "reference": f"rice_sale_tcash:{entry_id[:8]}",
            **base
        })
    ...
    if diesel_paid > 0:
        ...
        if truck_no:
            await db.cash_transactions.insert_one({
                ...
                "category": truck_no, "party_type": "Truck",
                "description": diesel_desc,
                "amount": round_amount(diesel_paid), "reference": f"rice_sale_tdiesel:{entry_id[:8]}",
                **base
            })
    ...
    if advance > 0:
        ...
        await db.cash_transactions.insert_one({
            ...
            "category": party, "party_type": "Rice Sale",
            "description": adv_desc,
            "amount": round_amount(advance), "reference": f"rice_sale_adv:{entry_id[:8]}",
            **base
        })
        await db.cash_transactions.insert_one({
            "id": str(uuid.uuid4()), "date": date,
            ...
            "category": party, "party_type": "Rice Sale",
            "description": adv_desc,
            "amount": round_amount(advance), "reference": f"rice_sale_adv_ledger:{entry_id[:8]}",
            **base
        })
