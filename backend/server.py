...
@api_router.put("/private-paddy/{item_id}")
...
@api_router.delete("/private-paddy/{item_id}")
...
@api_router.put("/rice-sales/{item_id}")
...
@api_router.delete("/rice-sales/{item_id}")
...
@api_router.post("/private-payments")
...
@api_router.get("/private-payments")
...
@api_router.delete("/private-payments/{pay_id}")
