      ...
      {data && data.grand_totals && (
        <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-7 gap-3">
          {[
            ...
            ["Total Mill W", data.grand_totals.total_mill_w, "Q", "text-amber-400"],
            ...
            <Card key={mandi.mandi_name} className="bg-slate-800 border-slate-700 overflow-hidden">
              ...
              >
                ...
                <div className="flex items-center gap-4 text-sm">
                  ...
                  <div className="text-center"><p className="text-[10px] text-slate-500">Mill W</p><p className="text-amber-400 font-bold">{fmtNum(mandi.totals.total_mill_w)}</p></div>
                  {mandi.extra_qntl > 0 && (
