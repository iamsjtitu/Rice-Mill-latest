...
const CHANGELOG = [
  {
    version: "93.0.0",
    date: "Apr 2026",
    title: "v93.0.0 - Weight Report PDF + WhatsApp PDF Document",
    items: [
      { type: "new", text: "Vehicle Weight: Professional PDF with 1st & 2nd weight + photos" },
      { type: "new", text: "WhatsApp/Telegram: PDF document directly bhejta hai (base64) - no URL dependency" },
      { type: "new", text: "Gunny Bags: Opening Stock support (Settings > Opening Stock)" },
      { type: "new", text: "Print Watermark: All print locations mein auto-inject" },
      { type: "fix", text: "Average Weight: Ab Net Weight / Bags = Per Bag Average dikhta hai" },
      { type: "fix", text: "Time: IST mein dikhta hai (UTC fix)" },
      { type: "fix", text: "WhatsApp: Bold text caption - *1st/2nd Weight Report - RST #X*" },
      { type: "fix", text: "WhatsApp: Message delay removed - instant delivery" },
      { type: "fix", text: "Desktop WhatsApp: Ab PDF document directly generate karke multipart form-data se 360Messenger ko bhejta hai" },
      { type: "fix", text: "Desktop: PDFKit se professional Weight Report PDF generate hota hai with photos, IST time, AVG/BAG" },
      { type: "fix", text: "PDF Watermark: Backslash fix (image-based)" },
    ],
  },
  {
    version: "92.0.0",
