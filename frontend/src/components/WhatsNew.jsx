...
const CHANGELOG = [
  {
    ...
    items: [
      ...
      { type: "fix", text: "Desktop WhatsApp: localhost PDF URL hata diya - ab sirf text bhejta hai (Desktop local hai, public URL nahi hota)" },
      { type: "fix", text: "Desktop: Auto-notify ab properly deliver hoga WhatsApp pe" },
