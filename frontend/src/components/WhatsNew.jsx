...
const CHANGELOG = [
  {
    ...
    items: [
      ...
      { type: "fix", text: "WhatsApp PDF: Ab tmpfiles.org pe upload karke public URL bhejta hai - 100% delivery guaranteed" },
      { type: "fix", text: "Desktop + Web dono mein same approach - PDF generate → tmpfiles upload → WhatsApp send" },
