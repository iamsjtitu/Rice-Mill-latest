                ...
                <table className="w-full" style={{ tableLayout: 'fixed' }}>
                  ...
                  <thead>
                    <tr className="border-b border-slate-600/60 bg-slate-700/50">
                      ...
                      <th className="text-right text-slate-400 text-[11px] font-semibold px-3 py-3 uppercase tracking-wider">Jama (Cr)</th>
                      <th className="text-right text-slate-400 text-[11px] font-semibold px-3 py-3 uppercase tracking-wider">Nikasi (Dr)</th>
