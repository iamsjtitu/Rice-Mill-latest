            ...
            <table className="w-full border-collapse text-[11px]">
              <tbody>
                ...
                <tr>
                  ...
                  <td className="border border-slate-600 px-2 py-1 text-slate-400 font-bold">{(((photoDialog.data.trans_type || '') + '').toLowerCase().includes('sale') || ((photoDialog.data.trans_type || '') + '').toLowerCase().includes('dispatch')) ? 'Destination' : 'Source/Mandi'}</td>
